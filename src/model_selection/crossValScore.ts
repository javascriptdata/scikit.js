...
interface EstimatorSupervised {
  fit(X: Tensor2D, y: Tensor1D): Promise<this>
}

interface EstimatorUnsupervised {
  fit(X: Tensor2D): Promise<this>
}

interface EstimatorWithScoreSupervised {
  fit(X: Tensor2D, y: Tensor1D): Promise<this>
  score(X: Tensor2D, y: Tensor1D): Scalar
}

interface EstimatorWithScoreUnsupervised {
  fit(X: Tensor2D): Promise<this>
 ...
 */
export async function crossValScore<T extends EstimatorSupervised>(
  estimator: T,
 ...
 *                 the {@link CrossValidator} `cv`
 */
export async function crossValScore<T extends EstimatorUnsupervised>(
  estimator: T,
  X: [Tensor2D],
  params: {
    cv?: CrossValidator
...
export async function crossValScore(
  estimator: EstimatorWithScoreSupervised,
  Xy: [Tensor2D, Tensor1D],
  params: {
    cv?: CrossValidator
    groups?: Tensor1D
 ...
 */
export async function crossValScore(
  estimator: EstimatorWithScoreUnsupervised,
  X: [Tensor2D, Tensor1D],
  params: {
    cv?: CrossValidator
    groups?: Tensor1D
