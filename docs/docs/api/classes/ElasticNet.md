---
id: "ElasticNet"
title: "Class: ElasticNet"
sidebar_label: "ElasticNet"
sidebar_position: 0
...
• **new ElasticNet**(`__namedParameters`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `__namedParameters` | `ElasticNetParams` |
...
[estimators/elastic.net.ts:32](https://github.com/dcrescim/scikit.js/blob/ae98366/scikitjs-node/src/estimators/elastic.net.ts#L32)
