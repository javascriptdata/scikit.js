...
title: "Class: LogisticRegression"
sidebar_label: "LogisticRegression"
sidebar_position: 0
...
• **new LogisticRegression**(`__namedParameters?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `__namedParameters` | `LogisticRegressionParams` |
...
estimators/logistic.regression.ts:31
